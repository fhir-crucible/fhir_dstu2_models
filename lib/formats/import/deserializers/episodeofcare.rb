    ...
    module Deserializer
        ...
        include FHIR::Deserializer::Utilities
            ...
            def parse_xml_entry(entry) 
                ...
                set_model_data(model, 'currentStatus', entry.at_xpath('./fhir:currentStatus/@value').try(:value))
                ...
                set_model_data(model, 'referralRequest', FHIR::Reference.parse_xml_entry(entry.at_xpath('./fhir:referralRequest')))
