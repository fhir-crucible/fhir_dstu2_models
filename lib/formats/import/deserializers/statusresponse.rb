module FHIR
    module Deserializer
        ...
        include FHIR::Deserializer::Utilities
            def parse_xml_entry_StatusResponseNotesComponent(entry) 
                return nil unless entry
                model = FHIR::StatusResponse::StatusResponseNotesComponent.new
            ...
            def parse_xml_entry(entry) 
                ...
                set_model_data(model, 'notes', entry.xpath('./fhir:notes').map {|e| parse_xml_entry_StatusResponseNotesComponent(e)})
