    ...
    class StructureDefinition
      ...
      def add_missing_elements(_name, missing_paths, elements, base_elements)
        ...
        missing_paths.each do |path|
          ...
          unless elem.nil?
            # _DEEP_ copy
            elements << FHIR::DSTU2::ElementDefinition.from_fhir_json(elem.to_fhir_json)
            next
          end
          ...
          type_elements.map! do |e| # {|e| FHIR::DSTU2::ElementDefinition.from_fhir_json(e.to_fhir_json) }
            FHIR::DSTU2::ElementDefinition.from_fhir_json(e.to_fhir_json)
          end
          # Fix path names
      ...
      def compare_extension_definition(x, y, another_definition)
        ...
        if !shared.nil? && shared.size.zero?
          ...
          x_extension = FHIR::DSTU2::Definitions.get_extension_definition(x.type[0].profile)
          y_extension = FHIR::DSTU2::Definitions.get_extension_definition(y.type[0].profile)
